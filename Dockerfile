# Build the Vite application with the Node version required by package.json.
...
# VITE_* values are embedded in the generated frontend bundle. Do not pass secrets.
